...
using PonavljanjePolimorfizamNasljedivanje;
...
internal class Program
{
	static void Main(string[] args)
	{
		...
		Console.WriteLine("Entry 1 rating: " + e1.getRating().ToString());
		...
		Console.WriteLine("Entry 2 rating: " + e2.getRating().ToString());
